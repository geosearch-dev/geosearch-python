    ...
    def make_instance(self, include_optional) -> ErrorResponseError:
        ...
        if include_optional:
            return ErrorResponseError(
                ...
                details = [
                    geosearch.models.error_response_error_details_inner.ErrorResponse_error_details_inner(
                        field = '', 
                        issue = '', )
                    ],
                request_id = 'req_abc123',
                trace_id = '4bf92f3577b34da6a3ce929d0e0e4736',
                quota = geosearch.models.quota_detail.QuotaDetail(
                    limit = 2000000, 
                    used = 2000000, 
                    resets_at = '2026-03-01T00:00:00Z', 
                    upgrade_url = 'https://geosearch.dev/dashboard/billing', ),
                upgrade = geosearch.models.upgrade_detail.UpgradeDetail(
                    upgrade_url = 'https://geosearch.dev/dashboard#billing', )
            )
        else:
            return ErrorResponseError(

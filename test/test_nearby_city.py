...
class TestNearbyCity(unittest.TestCase):
    """NearbyCity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NearbyCity:
        """Test NearbyCity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NearbyCity`
        """
        model = NearbyCity()
        if include_optional:
            return NearbyCity(

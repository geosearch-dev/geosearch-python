...
class TestGetStatus200ResponseData(unittest.TestCase):
    """GetStatus200ResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatus200ResponseData:
        """Test GetStatus200ResponseData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatus200ResponseData`
        """
        model = GetStatus200ResponseData()
        if include_optional:
    ...
    def testGetStatus200ResponseData(self):
        """Test GetStatus200ResponseData"""

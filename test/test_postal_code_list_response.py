...
class TestPostalCodeListResponse(unittest.TestCase):
    """PostalCodeListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostalCodeListResponse:
        """Test PostalCodeListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostalCodeListResponse`
        """
        model = PostalCodeListResponse()
        if include_optional:
            return PostalCodeListResponse(
                data = [
                    geosearch.models.postal_code.PostalCode(
                        id = 1140425, 
                        country_code = 'US', 
                        postal_code = '94105', 
    ...
    def testPostalCodeListResponse(self):
        """Test PostalCodeListResponse"""

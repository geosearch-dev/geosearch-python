...
class TestQuotaDetail(unittest.TestCase):
    """QuotaDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuotaDetail:
        """Test QuotaDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuotaDetail`
        """
        model = QuotaDetail()
        if include_optional:
            return QuotaDetail(

...
class TestRegionSingleResponse(unittest.TestCase):
    """RegionSingleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegionSingleResponse:
        """Test RegionSingleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionSingleResponse`
        """
        model = RegionSingleResponse()
        if include_optional:
            return RegionSingleResponse(
                data = geosearch.models.region.Region(
                    id = 5332921, 
                    geoname_id = 5332921, 
                    country_code = 'US', 
                    admin_code = 'CA', 
    ...
    def testRegionSingleResponse(self):
        """Test RegionSingleResponse"""

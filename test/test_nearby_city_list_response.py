...
class TestNearbyCityListResponse(unittest.TestCase):
    """NearbyCityListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NearbyCityListResponse:
        """Test NearbyCityListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NearbyCityListResponse`
        """
        model = NearbyCityListResponse()
        if include_optional:
            return NearbyCityListResponse(
                data = [
                    geosearch.models.nearby_city.NearbyCity(
                        id = 5391959, 
                        name = 'San Francisco', 
                        country_code = 'US', 
                        population = 873965, 
    ...
    def testNearbyCityListResponse(self):
        """Test NearbyCityListResponse"""

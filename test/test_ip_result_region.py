...
class TestIPResultRegion(unittest.TestCase):
    """IPResultRegion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPResultRegion:
        """Test IPResultRegion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPResultRegion`
        """
        model = IPResultRegion()
        if include_optional:
            return IPResultRegion(
                iso_code = 'CA',
                name = 'California'
            )
        else:

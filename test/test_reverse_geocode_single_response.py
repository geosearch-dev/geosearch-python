...
class TestReverseGeocodeSingleResponse(unittest.TestCase):
    """ReverseGeocodeSingleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReverseGeocodeSingleResponse:
        """Test ReverseGeocodeSingleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReverseGeocodeSingleResponse`
        """
        model = ReverseGeocodeSingleResponse()
        if include_optional:
            return ReverseGeocodeSingleResponse(
                data = geosearch.models.reverse_geocode_result.ReverseGeocodeResult(
                    city = geosearch.models.nearby_city.NearbyCity(
                        id = 5391959, 
                        name = 'San Francisco', 
                        country_code = 'US', 
                        population = 873965, 
                        ...
                        country = geosearch.models.country_ref.CountryRef(
                            iso_code = 'US', 
                            name = 'United States', ), 
                        region = geosearch.models.region_ref.RegionRef(
                            id = 5332921, 
                            name = 'California', 
                            admin_code = 'CA', ), ), 
                    distance_km = 0.3, )
    ...
    def testReverseGeocodeSingleResponse(self):
        """Test ReverseGeocodeSingleResponse"""

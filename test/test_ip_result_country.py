...
class TestIPResultCountry(unittest.TestCase):
    """IPResultCountry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPResultCountry:
        """Test IPResultCountry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPResultCountry`
        """
        model = IPResultCountry()
        if include_optional:
            return IPResultCountry(
                iso_code = 'US',
                name = 'United States',

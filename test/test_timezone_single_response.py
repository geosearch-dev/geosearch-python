...
class TestTimezoneSingleResponse(unittest.TestCase):
    """TimezoneSingleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimezoneSingleResponse:
        """Test TimezoneSingleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimezoneSingleResponse`
        """
        model = TimezoneSingleResponse()
        if include_optional:
            return TimezoneSingleResponse(
                data = geosearch.models.timezone.Timezone(
                    id = 56, 
                    country_code = 'US', 
    ...
    def testTimezoneSingleResponse(self):
        """Test TimezoneSingleResponse"""

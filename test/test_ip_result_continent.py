...
class TestIPResultContinent(unittest.TestCase):
    """IPResultContinent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPResultContinent:
        """Test IPResultContinent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPResultContinent`
        """
        model = IPResultContinent()
        if include_optional:
            return IPResultContinent(
                code = 'NA',
                name = 'North America'
            )
        else:
    ...
    def testIPResultContinent(self):
        """Test IPResultContinent"""

...
class TestCityListResponse(unittest.TestCase):
    """CityListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CityListResponse:
        """Test CityListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CityListResponse`
        """
        model = CityListResponse()
        if include_optional:
            return CityListResponse(
                data = [
                    geosearch.models.city.City(
                        id = 5391959, 
                        geoname_id = 5391959, 
                        name = 'San Francisco', 

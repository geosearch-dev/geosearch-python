...
class TestBatchApi(unittest.TestCase):
    ...
    def test_batch_cities(self) -> None:
        """Test case for batch_cities

        Batch lookup cities by IDs
        """
        pass

    def test_batch_countries(self) -> None:
        """Test case for batch_countries

        Batch lookup countries by IDs
        """
        pass

    def test_batch_regions(self) -> None:
        """Test case for batch_regions

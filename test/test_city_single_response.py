...
class TestCitySingleResponse(unittest.TestCase):
    """CitySingleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CitySingleResponse:
        """Test CitySingleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CitySingleResponse`
        """
        model = CitySingleResponse()
        if include_optional:
            return CitySingleResponse(
                data = geosearch.models.city.City(
                    id = 5391959, 
                    geoname_id = 5391959, 
                    name = 'San Francisco', 
    ...
    def testCitySingleResponse(self):
        """Test CitySingleResponse"""

...
class TestBoundarySingleResponse(unittest.TestCase):
    """BoundarySingleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoundarySingleResponse:
        """Test BoundarySingleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoundarySingleResponse`
        """
        model = BoundarySingleResponse()
        if include_optional:
            return BoundarySingleResponse(
                data = geosearch.models.boundary.Boundary(
                    geoname_id = 6252001, 
                    name = 'United States', 
                    type = 'country', 
                    geometry = geosearch.models.geo_json_geometry.GeoJSONGeometry(
                        type = 'MultiPolygon', 
    ...
    def testBoundarySingleResponse(self):
        """Test BoundarySingleResponse"""

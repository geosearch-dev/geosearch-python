...
class TestIPResultPostal(unittest.TestCase):
    """IPResultPostal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPResultPostal:
        """Test IPResultPostal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPResultPostal`
        """
        model = IPResultPostal()
        if include_optional:
            return IPResultPostal(
                code = '94043'
            )
        else:
            return IPResultPostal(

...
class TestReverseGeocodeResult(unittest.TestCase):
    """ReverseGeocodeResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReverseGeocodeResult:
        """Test ReverseGeocodeResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReverseGeocodeResult`
        """
        model = ReverseGeocodeResult()
        if include_optional:
    ...
    def testReverseGeocodeResult(self):
        """Test ReverseGeocodeResult"""

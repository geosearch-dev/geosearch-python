...
class TestIPResult(unittest.TestCase):
    """IPResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPResult:
        """Test IPResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPResult`
        """
        model = IPResult()
        if include_optional:
            return IPResult(

    ...
    def make_instance(self, include_optional) -> IPSingleResponse:
        ...
        if include_optional:
            return IPSingleResponse(
                data = geoapi.models.ip_result.IPResult(
                    ip = '8.8.8.8', 
                    network = '8.8.8.0/24', 
                    continent = geoapi.models.ip_result_continent.IPResult_continent(
                        code = 'NA', 
                        name = 'North America', ), 
                    country = geoapi.models.ip_result_country.IPResult_country(
                        iso_code = 'US', 
                        name = 'United States', 
                        is_in_european_union = False, ), 
                    region = geoapi.models.ip_result_region.IPResult_region(
                        iso_code = 'CA', 
                        name = 'California', ), 
                    city = geoapi.models.ip_result_city.IPResult_city(
                        name = 'Mountain View', ), 
                    postal = geoapi.models.ip_result_postal.IPResult_postal(
                        code = '94043', ), 
                    location = geoapi.models.ip_result_location.IPResult_location(
                        latitude = 37.386, 
                        longitude = -122.0838, 

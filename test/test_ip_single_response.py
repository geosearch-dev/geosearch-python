...
class TestIPSingleResponse(unittest.TestCase):
    """IPSingleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPSingleResponse:
        """Test IPSingleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPSingleResponse`
        """
        model = IPSingleResponse()
        if include_optional:
            return IPSingleResponse(
                data = geosearch.models.ip_result.IPResult(
                    ip = '8.8.8.8', 
                    network = '8.8.8.0/24', 
                    continent = geosearch.models.ip_result_continent.IPResult_continent(
                        code = 'NA', 
                        name = 'North America', ), 
                    country = geosearch.models.ip_result_country.IPResult_country(
                        iso_code = 'US', 
                        name = 'United States', 
                        is_in_european_union = False, ), 
                    region = geosearch.models.ip_result_region.IPResult_region(
                        iso_code = 'CA', 
                        name = 'California', ), 
                    city = geosearch.models.ip_result_city.IPResult_city(
                        name = 'Mountain View', ), 
                    postal = geosearch.models.ip_result_postal.IPResult_postal(
                        code = '94043', ), 
                    location = geosearch.models.ip_result_location.IPResult_location(
                        latitude = 37.386, 
                        longitude = -122.0838, 

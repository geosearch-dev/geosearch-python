...
class TestAutocompleteListResponse(unittest.TestCase):
    """AutocompleteListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutocompleteListResponse:
        """Test AutocompleteListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutocompleteListResponse`
        """
        model = AutocompleteListResponse()
        if include_optional:
            return AutocompleteListResponse(
                data = [
                    geosearch.models.autocomplete_result.AutocompleteResult(
                        id = 5391959, 
                        name = 'San Francisco', 
                        type = 'city', 
                        country_code = 'US', 
    ...
    def testAutocompleteListResponse(self):
        """Test AutocompleteListResponse"""

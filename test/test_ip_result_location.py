...
class TestIPResultLocation(unittest.TestCase):
    """IPResultLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPResultLocation:
        """Test IPResultLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPResultLocation`
        """
        model = IPResultLocation()
        if include_optional:
            return IPResultLocation(
                latitude = 37.386,
                longitude = -122.0838,

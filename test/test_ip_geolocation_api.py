...
from geosearch.api.ip_geolocation_api import IPGeolocationApi


class TestIPGeolocationApi(unittest.TestCase):
    """IPGeolocationApi unit test stubs"""

    def setUp(self) -> None:
        self.api = IPGeolocationApi()

    def tearDown(self) -> None:
        pass

    def test_lookup_ip(self) -> None:
        """Test case for lookup_ip

        IP geolocation lookup
        """
        pass

    def test_lookup_my_ip(self) -> None:
        """Test case for lookup_my_ip

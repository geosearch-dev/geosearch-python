...
class TestCountrySingleResponse(unittest.TestCase):
    """CountrySingleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountrySingleResponse:
        """Test CountrySingleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountrySingleResponse`
        """
        model = CountrySingleResponse()
        if include_optional:
            return CountrySingleResponse(
                data = geosearch.models.country.Country(
                    id = 1, 
                    geoname_id = 6252001, 
                    iso_code = 'US', 
                    iso3_code = 'USA', 
    ...
    def testCountrySingleResponse(self):
        """Test CountrySingleResponse"""

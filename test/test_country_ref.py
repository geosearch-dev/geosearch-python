...
class TestCountryRef(unittest.TestCase):
    """CountryRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountryRef:
        """Test CountryRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountryRef`
        """
        model = CountryRef()
        if include_optional:
            return CountryRef(

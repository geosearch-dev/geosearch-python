...
class TestHierarchyListResponse(unittest.TestCase):
    """HierarchyListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HierarchyListResponse:
        """Test HierarchyListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HierarchyListResponse`
        """
        model = HierarchyListResponse()
        if include_optional:
            return HierarchyListResponse(
                data = [
                    geosearch.models.hierarchy_node.HierarchyNode(
                        geoname_id = 5391959, 
                        name = 'San Francisco', 
                        type = 'city', 
                        depth = 0, )
    ...
    def testHierarchyListResponse(self):
        """Test HierarchyListResponse"""

...
class TestIPResultCity(unittest.TestCase):
    """IPResultCity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IPResultCity:
        """Test IPResultCity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IPResultCity`
        """
        model = IPResultCity()
        if include_optional:
            return IPResultCity(

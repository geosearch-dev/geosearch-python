...
from geosearch.configuration import Configuration
from geosearch.api_response import ApiResponse, T as ApiResponseT
import geosearch.models
from geosearch import rest
from geosearch.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(geosearch.models, klass)

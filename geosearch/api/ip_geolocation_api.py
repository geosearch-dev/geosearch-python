...
class IPGeolocationApi:
    ...
    def lookup_ip(
        self,
        address: Annotated[StrictStr, Field(description="IPv4 or IPv6 address")],
        ...
        :param address: IPv4 or IPv6 address (required)
        :type address: str
        ...
        _param = self._lookup_ip_serialize(
            address=address,
            lang=lang,
            fields=fields,
    ...
    @validate_call
    def lookup_ip_without_preload_content(
        self,
        address: Annotated[StrictStr, Field(description="IPv4 or IPv6 address")],
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to include in the response")] = None,
    ...
    def lookup_my_ip(
        ...
        _param = self._lookup_my_ip_serialize(
            lang=lang,
            fields=fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def lookup_my_ip_with_http_info(
        self,
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to include in the response")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def lookup_my_ip_without_preload_content(
        self,
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
        fields: Annotated[Optional[StrictStr], Field(description="Comma-separated list of fields to include in the response")] = None,
        _request_timeout: Union[

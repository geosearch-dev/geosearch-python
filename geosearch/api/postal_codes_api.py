...
class PostalCodesApi:
    ...
    def list_postal_codes(
        ...
        code: Annotated[Optional[StrictStr], Field(description="Filter by postal code")] = None,
        ...
        sort: Annotated[Optional[StrictStr], Field(description="Sort field. Allowed: postal_code, country_code, place_name, id.")] = None,
        ...
        :type country: str
        :param code: Filter by postal code
        :type code: str
        ...
        :type fields: str
        :param sort: Sort field. Allowed: postal_code, country_code, place_name, id.
        :type sort: str
        ...
        _param = self._list_postal_codes_serialize(
            lang=lang,
            country=country,
            code=code,
            within=within,
    ...
    @validate_call
    def list_postal_codes_with_http_info(
        self,
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
        country: Annotated[Optional[StrictStr], Field(description="Filter by ISO alpha-2 country codes (comma-separated)")] = None,
        code: Annotated[Optional[StrictStr], Field(description="Filter by postal code")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PostalCodeListResponse]:
        """List postal codes
    ...
    @validate_call
    def list_postal_codes_without_preload_content(
        self,
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
        country: Annotated[Optional[StrictStr], Field(description="Filter by ISO alpha-2 country codes (comma-separated)")] = None,
        code: Annotated[Optional[StrictStr], Field(description="Filter by postal code")] = None,
    ...
    def _list_postal_codes_serialize(
        self,
        lang,
        country,
        code,
    ...
    def nearest_postal_code(
        ...
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=10, strict=True, ge=1)]], Field(description="Number of results (1-10, default 1)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param lang: ISO 639-1 language code for localized names (e.g., de, fr, ja)
        :type lang: str
        :param limit: Number of results (1-10, default 1)
        :type limit: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._nearest_postal_code_serialize(
            lat=lat,
            lon=lon,
            lang=lang,
            limit=limit,
    ...
    @validate_call
    def nearest_postal_code_with_http_info(
        self,
        lat: Annotated[Union[Annotated[float, Field(le=90, strict=True, ge=-90)], Annotated[int, Field(le=90, strict=True, ge=-90)]], Field(description="Latitude (-90 to 90)")],
        lon: Annotated[Union[Annotated[float, Field(le=180, strict=True, ge=-180)], Annotated[int, Field(le=180, strict=True, ge=-180)]], Field(description="Longitude (-180 to 180)")],
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
    ...
    @validate_call
    def nearest_postal_code_without_preload_content(
        self,
        lat: Annotated[Union[Annotated[float, Field(le=90, strict=True, ge=-90)], Annotated[int, Field(le=90, strict=True, ge=-90)]], Field(description="Latitude (-90 to 90)")],
        lon: Annotated[Union[Annotated[float, Field(le=180, strict=True, ge=-180)], Annotated[int, Field(le=180, strict=True, ge=-180)]], Field(description="Longitude (-180 to 180)")],
        lang: Annotated[Optional[Annotated[str, Field(min_length=2, strict=True, max_length=5)]], Field(description="ISO 639-1 language code for localized names (e.g., de, fr, ja)")] = None,
    ...
    def _nearest_postal_code_serialize(
        self,
        lat,
        lon,
        lang,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/postal-codes/nearest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,

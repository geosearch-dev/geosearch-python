...
class IPResultCountry(BaseModel):
    """
    IPResultCountry
    """ # noqa: E501
    iso_code: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    is_in_european_union: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["iso_code", "name", "is_in_european_union"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "is_in_european_union": obj.get("is_in_european_union")
        })
        return _obj

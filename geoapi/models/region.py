...
class Region(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "admin_code": obj.get("admin_code"),
            "name": obj.get("name"),
            "ascii_name": obj.get("ascii_name"),
            "level": obj.get("level"),
            "parent_geoname_id": obj.get("parent_geoname_id"),

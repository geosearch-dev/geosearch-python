...
class Timezone(BaseModel):
    ...
    gmt_offset: Optional[Union[StrictFloat, StrictInt]] = None
    dst_offset: Optional[Union[StrictFloat, StrictInt]] = None
    raw_offset: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "country_code", "timezone_id", "gmt_offset", "dst_offset", "raw_offset"]

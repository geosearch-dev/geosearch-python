...
class PaginationMeta(BaseModel):
    ...
    prev_cursor: Optional[StrictStr] = Field(default=None, description="Cursor for the previous page")
    has_next: Optional[StrictBool] = None
    has_prev: Optional[StrictBool] = None
    count: Optional[StrictInt] = Field(default=None, description="Number of items in this response")
    __properties: ClassVar[List[str]] = ["next_cursor", "prev_cursor", "has_next", "has_prev", "count"]

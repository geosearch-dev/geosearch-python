...
class NearbyCity(BaseModel):
    ...
    distance_km: Optional[Union[StrictFloat, StrictInt]] = None
    country: Optional[CountryRef] = None
    region: Optional[RegionRef] = None
    __properties: ClassVar[List[str]] = ["id", "name", "country_code", "population", "timezone", "latitude", "longitude", "distance_km", "country", "region"]

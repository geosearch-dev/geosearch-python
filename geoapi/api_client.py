...
from geoapi.configuration import Configuration
from geoapi.api_response import ApiResponse, T as ApiResponseT
import geoapi.models
from geoapi import rest
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(geoapi.models, klass)

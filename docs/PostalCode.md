...
**admin_name3** | **str** | Third-level administrative area. Empty where the source data defines none — most US rows, including this example. | [optional] 
**admin_code3** | **str** | Third-level administrative code. Empty where the source data defines none — most US rows, including this example. | [optional] 
